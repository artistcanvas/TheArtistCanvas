...
function FooterContactItem({ link }: { link: FooterContactLink }) {
  const className = "text-[14px] text-[#EAEAEC]";
        ...
        <div className="flex min-w-0 flex-col items-start gap-[40px] md:items-end md:gap-[61px]">
          ...
          <div className="flex gap-[10px]">
            <a
              ...
              className="rounded-full border flex justify-center items-center border-white/10 w-[34px] h-[34px] transition hover:border-white/30"
