  ...
  return (
    ...
    >
      <div className="absolute left-1/2 top-1/2 flex w-full max-w-[1920px] -translate-x-1/2 -translate-y-1/2 flex-col items-end gap-[clamp(72px,calc((249/1920)*100vw),249px)] px-5 md:flex-row md:justify-between md:gap-10 md:px-0 md:pl-[90px] md:pr-[clamp(90px,calc((201/1920)*100vw),201px)]">
        <div className="relative mx-auto aspect-[922/356] w-full shrink md:mx-0 md:w-[min(100%,clamp(335px,calc((922/1920)*100vw),922px))]">
          <Image
            width={922}
            height={356}
            src={MainLogo}
      ...
      <div className="absolute bottom-[5%] left-1/2 hidden -translate-x-1/2 flex-col items-center gap-[clamp(18px,calc((60/1920)*100vw),60px)] md:flex">
        <p className="text-center font-semibold text-[clamp(16px,calc((50/1920)*100vw),50px)] leading-none text-white">
          상상은 현실이 된다
        </p>
