...
export const Hero = () => {
  return (
    <div className="pb-[56px] pt-[128px] md:pb-15 flex flex-col gap-11 items-center justify-end w-full h-svh min-h-max">
      <div className="flex flex-col items-end gap-[249px] w-full h-full max-w-[1920px] md:justify-between md:gap-10 px-5 md:flex-row md:pl-[90px] md:pr-[clamp(90px,calc((201/1920)*100vw),201px)] md:h-auto">
        <div className="relative mx-auto w-[min(100%,clamp(335px,calc((922/1920)*100vw),922px))] shrink aspect-[922/356] md:mx-0">
          <Image
            width={922}
            height={356}
            src={MainLogo}
        ...
        <div className="mx-auto flex w-[min(100%,clamp(335px,calc((922/1920)*100vw),922px))] flex-col items-end space-y-[clamp(17px,calc((60/1920)*100vw),60px)] md:mx-0 md:w-auto md:items-start">
